package com.philipshealthcare.actiondriver;
import java.io.File;
...
import com.philipshealthcare.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface{
	...
	public boolean isSelected(WebDriver driver, WebElement ele) {		boolean flag = false;
		flag = findElement(driver, ele);
		if (flag) {
			flag = ele.isSelected();
			if (flag) {
